 ...
 try{
     $sql = "select * from yu14db.secinfo where num=?";
     ...
     try{
       ...
       $sql = "update yu14db.secinfo set hit=? where num=?";   // 조회수 증가
       $stmh = $pdo->prepare($sql);  
 ...
 <div id="wrap">
  ...
  <div id="content">
     <div id="col1">
	<div id="left_menu"><?php include "../lib/left_menu6.php"; ?></div>
     </div>
      <div id="col2">
	<div id="title">보안 지식 게시판</div>
