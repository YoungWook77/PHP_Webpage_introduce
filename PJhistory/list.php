<?php
 ...
 <?php
  ...
  <?php
   ...
   $sql="select * from yu14db.PJhistory where $find like '%$search%' order by num desc";
  } else {
   $sql="select * from yu14db.PJhistory order by num desc";
  }
  try{  
    $stmh = $pdo->query($sql); 
    $count=$stmh->rowCount(); 
  ...
  <div id="wrap">
    ...
    <div id="content">
      <div id="col1">
        <div id="left_menu">
         <?php include "../lib/left_menu3.php"; ?>
        </div> 
      </div> <!-- end of col1 --> 
