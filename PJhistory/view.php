 ...
 $file_dir = 'C:\xampp\htdocs\YUproject\data\\'; 
 ...
 try{
     $sql = "select * from yu14db.PJhistory where num=?";
     ...
     try{
       ...
       $sql = "update yu14db.Pjhistory set hit=? where num=?";   // 조회수 증가
       $stmh = $pdo->prepare($sql);  
 ...
 <div id="wrap">
  ...
  <div id="content">
     <div id="col1">
	<div id="left_menu"><?php include "../lib/left_menu3.php"; ?></div>
     </div>
      <div id="col2">
	<div id="title">프로젝트 이력 게시판</div>
